    ...
    return (
        <div className="h-full min-h-0 overflow-auto bg-[#020918] p-2 text-cyan-50 selection:bg-cyan-500/50 xl:overflow-hidden">
            <div className="relative mx-auto flex min-h-full max-w-[1900px] flex-col overflow-hidden border-2 border-cyan-400/60 bg-[radial-gradient(circle_at_50%_0%,rgba(14,165,233,.24),transparent_38%),linear-gradient(125deg,#031229,#062e5a_52%,#04152f)] p-3 shadow-[inset_0_0_55px_rgba(14,165,233,.16),0_0_30px_rgba(14,165,233,.25)] before:pointer-events-none before:absolute before:inset-0 before:opacity-20 before:[background-image:linear-gradient(rgba(34,211,238,.14)_1px,transparent_1px),linear-gradient(90deg,rgba(34,211,238,.14)_1px,transparent_1px)] before:[background-size:42px_42px] xl:h-full xl:min-h-0">
                ...
                <main className="relative grid min-h-0 flex-1 grid-cols-1 gap-3 overflow-auto xl:grid-cols-[.78fr_2.1fr_1fr] xl:grid-rows-[minmax(0,1fr)] xl:overflow-hidden">
                    ...
                    <div className="grid min-h-[680px] min-w-0 grid-rows-[1.3fr_.7fr] gap-3 xl:min-h-0">
...
function TechFrame({ title, icon, action, children }) {
    return <section className="relative flex h-full min-h-0 flex-col overflow-hidden border-2 border-cyan-400/75 bg-[linear-gradient(155deg,rgba(3,31,72,.96),rgba(5,54,104,.86)_52%,rgba(3,25,62,.96))] p-3.5 shadow-[inset_0_0_34px_rgba(14,165,233,.16),0_0_18px_rgba(0,174,255,.2)]" style={{ clipPath: 'polygon(14px 0, calc(100% - 14px) 0, 100% 14px, 100% calc(100% - 14px), calc(100% - 14px) 100%, 14px 100%, 0 calc(100% - 14px), 0 14px)' }}>
        <div className="pointer-events-none absolute inset-0 opacity-20 [background-image:radial-gradient(circle,rgba(56,189,248,.55)_1px,transparent_1px)] [background-size:18px_18px]" />
        <div className="pointer-events-none absolute left-8 right-8 top-0 h-0.5 bg-gradient-to-r from-transparent via-cyan-200 to-transparent shadow-[0_0_12px_#38bdf8]" />
        <i className="pointer-events-none absolute left-2 top-2 h-5 w-5 border-l-2 border-t-2 border-cyan-200 shadow-[-2px_-2px_8px_rgba(34,211,238,.45)]" />
        <i className="pointer-events-none absolute bottom-2 right-2 h-5 w-5 border-b-2 border-r-2 border-cyan-200 shadow-[2px_2px_8px_rgba(34,211,238,.45)]" />
        {title && <div className="relative mb-3 flex min-h-9 shrink-0 items-center justify-center border-b border-cyan-300/35 pb-2 text-[17px] font-black tracking-[.12em] text-white drop-shadow-[0_0_7px_rgba(103,232,249,.8)]"><span className="mr-2 text-cyan-200"><i className={`fas ${icon}`} /></span><span className="h-px w-8 bg-gradient-to-r from-transparent to-cyan-300/80" /><span className="mx-3">{title}</span><span className="h-px w-8 bg-gradient-to-l from-transparent to-cyan-300/80" />{action && <span className="absolute right-0 top-0">{action}</span>}</div>}
